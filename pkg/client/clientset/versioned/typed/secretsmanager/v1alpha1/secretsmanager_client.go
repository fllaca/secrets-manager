...
import (
	...
	"github.com/tuenti/secrets-manager/pkg/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*SecretsmanagerV1alpha1Client, error) {
	...
	return &SecretsmanagerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SecretsmanagerV1alpha1Client for the given config and
...
func New(c rest.Interface) *SecretsmanagerV1alpha1Client {
	return &SecretsmanagerV1alpha1Client{c}
}
...
func (c *SecretsmanagerV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
